...
const PostCard = ({ post, username }) => {
  ...
  return (
    <div className="w-full px-4 overflow-y-auto py-2 bg-white text-black">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <Link to={`profile/${post.userId._id}`}>
              <h2 className="font-semibold text-md">{post?.userId?.username || username}</h2>
            </Link>
      ...
      <div>
        ...
        <div className="mt-3">
          {post.photoUrl &&
            (Array.isArray(post.photoUrl) ? (
              <img
                src={post.photoUrl[0] || "/placeholder.svg"}
                alt=""
        ...
        <div className="flex py-3 item-center justify-between">
          <div className="flex  items-center gap-12">
            ...
            <motion.button whileTap={{ scale: 1.3 }} className="" onClick={() => handelComment()}>
